...
namespace PhaseEndProject.Controllers
{
    public class CustLogInfoesController : Controller
    {
        ...
        public CustLogInfoesController(EmpdbContext context)
        {
            _context = context;
        }
        ...
        {
            var empdbContext = _context.CustLogInfos.Include(c => c.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EmpdbContext.CustLogInfos'  is null.");
            }
            var custLogInfo = await _context.CustLogInfos.FindAsync(id);
            if (custLogInfo != null)
            {
